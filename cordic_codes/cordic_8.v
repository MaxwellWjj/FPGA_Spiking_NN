...
function [`THETA_BITS:0] tanangle;
  ...
  begin
    ...
    4'd01: tanangle = 33'd32;   //  1/2
    4'd02: tanangle = 33'd16;     //  1/4
    4'd03: tanangle = 33'd8;     //  1/8
    4'd04: tanangle = 33'd4;     //  1/16
    4'd05: tanangle = 33'd2;     //  1/32
    4'd06: tanangle = 33'd1;      //  1/64
    4'd07: tanangle = 33'd0;      //  1/128
    default:tanangle = 33'd0;
    endcase
  end
endfunction
`endif
...
/*    else*/ if (rst) done <= 0;
  ...
  rotator_8 U (clk,rst,init,iteration,tanangle(iteration),x,y,z,x_o,y_o,theta_o);
