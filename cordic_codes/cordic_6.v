...
*/
`define ITERATIONS 6
`define ITERATION_BITS 3  // 2^ITERATION_BITS = ITERATIONS
...
//  signed_shifter_6 x_shifter(iteration,x_i,x_i_shifted);
//  signed_shifter_6 y_shifter(iteration,y_i,y_i_shifted);
...
function [`THETA_BITS:0] tanangle;
  ...
  begin
    case (i)
    3'd00: tanangle = 8'b0010001;   
    3'd01: tanangle = 8'b0001000;   
    3'd02: tanangle = 8'b0000100;     
    3'd03: tanangle = 8'b0000010;     
    3'd04: tanangle = 8'b0000001;     
    3'd05: tanangle = 8'b0000000;         
    endcase
  end
endfunction
`endif
...
/*    else*/ if (rst) done <= 0;
  ...
  rotator_6 U (clk,rst,init,iteration,tanangle(iteration),x,y,z,x_o,y_o,theta_o);
